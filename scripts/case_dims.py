...
PIN_STUB = 1.0  # every through-hole pin is trimmed under the board to this much of stub and solder
STUB_TIP_Z = -BOARD_T - PIN_STUB  # -2.6: where the trimmed pins end
...
CAV_Z0, CAV_Z1 = STUB_TIP_Z - 0.5, HIGHEST + 1.1  # -3.1 .. 9.6: under the pin stubs (-2.6) and the back-side 0805s (-2.2), over the header pins
...
STANDOFF_Z0, STANDOFF_Z1 = CAV_Z0, -BOARD_T  # 1.5 tall, floor to the board's underside
