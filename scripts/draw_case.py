...
def checklist() -> list[tuple[str, str, list[tuple[str, float]], str]]:
    ...
    return [
        ...
        (f"Bottom half, depth rod with its base across both lips at y = {d.SECTION_DD_Y:g} (section D-D, no tab there), the lips {fmt(d.LIP_H)} above the rim: floor; standoff top; peg tip (H1, H2, H4); peg tip H3", "{}; {}; {}; {}",
        ...
        ("Bottom half: standoff diameter; standoff height, floor to the PCB's underside (the trimmed pin stubs' room); standoff pitch, across x along", "{}; {}; {} x {}", [("standoff_d_H1", d.STANDOFF_D), ("standoff_h", d.STANDOFF_Z1 - d.STANDOFF_Z0), ("hole_pitch_x", d.W - 2 * d.HOLE_IN), ("hole_pitch_y", d.H - 2 * d.HOLE_IN)], TOL_LIN),
