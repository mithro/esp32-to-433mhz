...
- CC1101 blue: the OOK-PWM edge-capture path is live-verified on hardware
  ...
  offset). The earlier `Decoded=0` runs predate that fix; blue's live decode, and
  the real-broker HA verification, are recorded in
...
- SX1278 (Ra-02): Fine Offset FSK RX is both host-tested and **confirmed decoding
  ...
  reference; recorded in [`HWTEST-RESULTS-cc1101.md`](HWTEST-RESULTS-cc1101.md)).
