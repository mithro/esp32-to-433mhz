...
against photos and datasheets. They are kept as
...
| [`hardware/sx1278-ra02-breakout`](#sx1278-ra-02-breakout) | SX1278 LoRa 433MHz v4.0 breakout (Ai-Thinker Ra-02 + 2x4 header) | 17.5 x 22.5 |
...
Reference reproductions of the four commercial boards the adapters are built
...
`hardware/esp32-c3-supermini`. The grey half-circles outside the outline in
...
`hardware/cc1101-e07-m1101d`: the Ebyte E07-M1101D-SMA (PCB marked
...
`hardware/sx1278-ra02-breakout`: the blue "SX1278 LoRa 433MHz v4.0"
...
`hardware/sx1278-lora-module`: the 16-pin castellated 433 MHz SX1278 module
